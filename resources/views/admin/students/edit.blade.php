                            ...
                            <div class="form-row row mb-4">
                                <div class="col-md-6 form-group text-right">
                                    <input name="name" autofocus type="text" id="" class="form-control"
                                        placeholder="اسم الطالب / الطالبه" value="{{ $user->name }}" />
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-md-6 form-group text-right">
                                    <input name="phone" type="text" maxlength="12" id="" class="form-control"
                                        placeholder="رقم هاتف الطالب" value="{{ $user->phone }}" />
                                    @if ($errors->has('phone'))
                                ...
                                <div class="col-md-6 form-group text-right">
                                    <input name="parent_phone" type="text" maxlength="11" id=""
                                        class="form-control" placeholder="رقم ولي الامر" value="{{ $user->parent_phone }}" />
