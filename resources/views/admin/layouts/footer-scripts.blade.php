...
<script src="{{ asset('bacend/assets/plugins/fancyuploder/jquery.ui.widget.js') }}"></script>
<script src="{{ asset('bacend/assets/plugins/fancyuploder/jquery.fileupload.js') }}"></script>
<script src="{{ asset('bacend/assets/plugins/fancyuploder/jquery.iframe-transport.js') }}"></script>
<script src="{{ asset('bacend/assets/plugins/fancyuploder/jquery.fancy-fileupload.js') }}"></script>
<script src="{{ asset('bacend/assets/plugins/fancyuploder/fancy-uploader.js') }}"></script>
