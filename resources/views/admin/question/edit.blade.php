            ...
            <form action="{{ route('admin.questions.update', $question->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">تحديث سؤال</div>
                    </div>
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <select name="exam_id" class="form-select" aria-label="Default select example">
                                    ...
                                    @foreach ($exams as $exam)
                                        <option value="{{ $exam->id }}" {{ $exam->id == $exam->id ? 'selected' : '' }}>
                                            {{ $exam->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input name="score" type="number" class="form-control" value="{{ $question->score }}">
                                @if ($errors->has('score'))
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea name="answers" id="options" required class="form-control">
                                    {{ $question->answers }}
                                </textarea>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="row">
                            <div class="col-md-6 text-start">
                                <button type="submit" class="btn btn-success p-2">تحديث وإضافة سؤال اخر</button>
                            </div>
                        </div>
                        <!--End Row-->
                    </div>
