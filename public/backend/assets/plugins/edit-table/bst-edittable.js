...
class BSTable {
    ...
    constructor(tableId, options) {
        ...
        var defaults = {
            ...
            advanced: { // Do not override advanced unless you know what youre doing
                columnLabel: 'تعديل',
                buttonHTML: `<div class="btn-list text-center">
     ...
     */
    init() {
        this.table.find('thead tr').append('<th name="bstable-actions"  style="text-align:center;">' + this.options.advanced.columnLabel + '</th>'); // Append column to header
